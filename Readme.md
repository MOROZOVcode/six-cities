...
По окончанию обучения успешно защитил проект на _100 баллов_ и получил **_сертификат._**

<img width="60%" title="certificate" alt="certificate" src="https://github.com/MOROZOVcode/MOROZOVcode/blob/main/other/forReadme/six-cities/certificate_react.jpg">
...
Чтобы получить больше **_информации_** и **_инструкций_** о проекте, можно перейтити по этой ссылке: [github.com/MOROZOVcode/six-cities/tree/master/projec/Readme.md](https://github.com/MOROZOVcode/six-cities/blob/master/project/Readme.md)
